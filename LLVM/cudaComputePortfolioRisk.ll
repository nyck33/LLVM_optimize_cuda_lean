; ModuleID = 'cudaComputePortfolioRisk.cu'
...
for.cond.cleanup.loopexit.unr-lcssa:              ; preds = %for.body, %for.body.lr.ph
  ...
  %k.035.unr = phi i32 [ 0, %for.body.lr.ph ], [ %inc.3, %for.body ]
...
for.body.epil:                                    ; preds = %for.cond.cleanup.loopexit.unr-lcssa, %for.body.epil
  ...
  %7 = load double, ptr %arrayidx.epil, align 8, !tbaa !8
  ...
  %8 = load double, ptr %arrayidx15.epil, align 8, !tbaa !8
  %mul16.epil = fmul contract double %7, %8
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %10 = load double, ptr %arrayidx15, align 8, !tbaa !8
  %mul16 = fmul contract double %9, %10
  ...
  %11 = load double, ptr %arrayidx.1, align 8, !tbaa !8
  ...
  %12 = load double, ptr %arrayidx15.1, align 8, !tbaa !8
  %mul16.1 = fmul contract double %11, %12
  ...
  %13 = load double, ptr %arrayidx.2, align 8, !tbaa !8
  ...
  %14 = load double, ptr %arrayidx15.2, align 8, !tbaa !8
  %mul16.2 = fmul contract double %13, %14
  ...
  %15 = load double, ptr %arrayidx.3, align 8, !tbaa !8
  ...
  %16 = load double, ptr %arrayidx15.3, align 8, !tbaa !8
  %mul16.3 = fmul contract double %15, %16
